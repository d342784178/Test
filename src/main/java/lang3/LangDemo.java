...
public class LangDemo {
    ...
    public void charSetUtilsDemo() {
        ...
        System.out.println(CharSetUtils.squeeze("run  bbbbbb     c dd", "b d"));
    }
    ...
    public void serializationUtilsDemo() {
        ...
        try {
            ...
            Date reDate2 = SerializationUtils.deserialize(fis);
    ...
    public void stringUtilsDemo() {
        ...
        String[] strArray = StringUtils.split("run,b,,c,d,null,e", ",");
    ...
    public void builderDemo() {
        ...
        BuildDemo obj1 = new BuildDemo("run", 1);
        BuildDemo obj2 = new BuildDemo("b", 2);
        BuildDemo obj3 = new BuildDemo("run", 1);
